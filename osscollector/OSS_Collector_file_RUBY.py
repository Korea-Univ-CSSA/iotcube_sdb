...
gitCloneURLS= currentPath + "/sample_rb" 			# Please change to the correct file (the "sample" file contains only 10 git-clone urls)
clonePath 	= "/mnt/sdb1/ruby/centris_repo/repo_src/"		# Default path
tagDatePath = "/mnt/sdb1/ruby/centris_repo/repo_date/"		# Default path
# resultPath	= currentPath + "/repo_file/"		# Default path
resultPathFile = "/mnt/sdb1/ruby/centris_repo/repo_files/"
...
def md5File(fname, ext):
	...
	with open(fname, "r", encoding="utf-8", errors="ignore") as f:
		fileContent = f.read()
		fileContent = normalize(removeComment(fileContent, ext))
