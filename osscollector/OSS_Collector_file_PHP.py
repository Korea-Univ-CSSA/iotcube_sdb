...
gitCloneURLS= currentPath + "/sample_php" 			# Please change to the correct file (the "sample" file contains only 10 git-clone urls)
clonePath 	= "/mnt/sdb1/php/centris_repo/repo_src/"		# Default path
tagDatePath = "/mnt/sdb1/php/centris_repo/repo_date/"		# Default path
# resultPath	= currentPath + "/repo_file/"		# Default path
resultPathFile = "/mnt/sdb1/php/centris_repo/repo_files/"
...
def removeComment(string): # PHP 주석 처리 추가 (PHP에서는 #도 단일 주석으로 사용)
