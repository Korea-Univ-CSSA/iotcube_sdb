...
gitCloneURLS= currentPath + "/sample_js" 			# Please change to the correct file (the "sample" file contains only 10 git-clone urls)
clonePath 	= "/mnt/sdb1/js/centris_repo/repo_src/"		# Default path
tagDatePath = "/mnt/sdb1/js/centris_repo/repo_date/"		# Default path
# resultPath	= currentPath + "/repo_file/"		# Default path
resultPathFile = "/mnt/sdb1/js/centris_repo/repo_files/"
