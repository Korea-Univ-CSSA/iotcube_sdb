...
DBPath          = currentPath
resultPath		= ""
finalDBPath		= DBPath + "/../../../../../mnt/sdb1/java/preprocessor/componentDB/"
finalDBPathFile = DBPath + "/../../../../../mnt/sdb1/java/preprocessor/componentDB_file/"
aveFuncPath		= DBPath + "/../../../../../mnt/sdb1/java/preprocessor/metaInfos/aveFuncs"
aveFilePath		= DBPath + "/../../../../../mnt/sdb1/java/preprocessor/metaInfos/aveFiles"
ctagsPath		= currentPath + "/../../impl/bin/ctags"
verFuncPath		= DBPath + "/../../../../../mnt/sdb1/java/preprocessor/verIDX_func/"
verFilePath		= DBPath + "/../../../../../mnt/sdb1/java/preprocessor/verIDX_file/"
					...
					for i in allFuncs:
						...
						if i != '' and len(elemList) >= 8 and func.fullmatch(elemList[3]):
							...
							if funcSearch.search(tmpString):
								...
								funcBody = " "
							funcBody = remove_go_imports(funcBody)
