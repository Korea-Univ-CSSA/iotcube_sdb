...
DBPath          = currentPath
resultPath		= ""
finalDBPath		= DBPath + "/../../../../../mnt/sdb1/python/preprocessor/componentDB/"
finalDBPathFile = DBPath + "/../../../../../mnt/sdb1/python/preprocessor/componentDB_file/"
aveFuncPath		= DBPath + "/../../../../../mnt/sdb1/python/preprocessor/metaInfos/aveFuncs"
aveFilePath		= DBPath + "/../../../../../mnt/sdb1/python/preprocessor/metaInfos/aveFiles"
ctagsPath		= currentPath + "/../../impl/bin/ctags"
verFuncPath		= DBPath + "/../../../../../mnt/sdb1/python/preprocessor/verIDX_func/"
verFilePath		= DBPath + "/../../../../../mnt/sdb1/python/preprocessor/verIDX_file/"
					...
					for i in allFuncs:
						...
						if i != '' and len(elemList) >= 8 and func.fullmatch(elemList[3]):
							...
							if funcSearch.search(tmpString):
								...
								funcBody = " "
							funcBody = removePyComment(funcBody)
