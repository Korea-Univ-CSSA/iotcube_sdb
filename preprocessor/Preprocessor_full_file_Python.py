...
verIDXpath		= currentPath + "/../../../../../mnt/sdb1/python/preprocessor/verIDX_file/"				# Default path
initialDBPath	= currentPath + "/../../../../../mnt/sdb1/python/preprocessor/initialSigs/"  			# Default path
finalDBPath		= currentPath + "/../../../../../mnt/sdb1/python/preprocessor/componentDB_file/"  		# Default path of the final Component DB
metaPath		= currentPath + "/../../../../../mnt/sdb1/python/preprocessor/metaInfos/"				# Default path, for saving pieces of meta-information of collected repositories
weightPath		= metaPath 	  + "/../../../../../mnt/sdb1/python/preprocessor/weights/"					# Default path, for version prediction
fileDatePath	= currentPath + "/../../../../../mnt/sdb1/python/preprocessor/fileDate/"				# Default path
