...
tagDatePath 	= "/mnt/sdb1/php/centris_repo/repo_date/" 							# Default path
resultPath		= "/mnt/sdb1/php/centris_repo/repo_files/" 							# Default path
# resultPath		= "../tmp_db/" 							# Default path
verIDXpath		= currentPath + "/../../../../../mnt/sdb1/php/preprocessor/verIDX_file/"				# Default path
initialDBPath	= currentPath + "/../../../../../mnt/sdb1/php/preprocessor/initialSigs/"  			# Default path
finalDBPath		= currentPath + "/../../../../../mnt/sdb1/php/preprocessor/componentDB_file/"  		# Default path of the final Component DB
metaPath		= currentPath + "/../../../../../mnt/sdb1/php/preprocessor/metaInfos/"				# Default path, for saving pieces of meta-information of collected repositories
weightPath		= metaPath 	  + "/../../../../../mnt/sdb1/php/preprocessor/weights/"					# Default path, for version prediction
fileDatePath	= currentPath + "/../../../../../mnt/sdb1/php/preprocessor/fileDate/"				# Default path
