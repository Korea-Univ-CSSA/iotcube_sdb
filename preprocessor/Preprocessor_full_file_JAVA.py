...
tagDatePath 	= "/mnt/sdb1/java/centris_repo/repo_date/" 							# Default path
resultPath		= "/mnt/sdb1/java/centris_repo/repo_files/" 							# Default path
# resultPath		= "../tmp_db/" 							# Default path
verIDXpath		= currentPath + "/../../../../../mnt/sdb1/java/preprocessor/verIDX_file/"				# Default path
initialDBPath	= currentPath + "/../../../../../mnt/sdb1/java/preprocessor/initialSigs/"  			# Default path
finalDBPath		= currentPath + "/../../../../../mnt/sdb1/java/preprocessor/componentDB_file/"  		# Default path of the final Component DB
metaPath		= currentPath + "/../../../../../mnt/sdb1/java/preprocessor/metaInfos/"				# Default path, for saving pieces of meta-information of collected repositories
weightPath		= metaPath 	  + "/../../../../../mnt/sdb1/java/preprocessor/weights/"					# Default path, for version prediction
fileDatePath	= currentPath + "/../../../../../mnt/sdb1/java/preprocessor/fileDate/"				# Default path
